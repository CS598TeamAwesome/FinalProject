...
# A generic script that can be customized using various environmental variables
...
# supervisor command removed below
    NCMD="supervisor -n exit -w ./app,./rpc,./model,$NODE_CONFIG_DIR,$NODE_LAUNCH_SCRIPT"
fi
